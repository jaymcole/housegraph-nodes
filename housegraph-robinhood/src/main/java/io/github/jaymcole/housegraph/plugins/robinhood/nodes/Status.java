 ...
 * One helper for both beats seven copies of the same four lines. (The API this library pins has no
 * {@code BaseNode.present(Runnable)}; when it is rebuilt against one that does, this is the class
 * that goes.)
 */
final class Status {
    ...
    static Label label(String initialText) {
